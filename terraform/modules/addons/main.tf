...
resource "helm_release" "metrics_server" {
  ...
  # Em EKS normalmente não precisa args extra; se precisar depois a gente ajusta.
}
    ...
    Statement = [
      {
        ...
        Condition = {
          StringEquals = {
            "${local.oidc_issuer_hostpath}:sub" = "system:serviceaccount:kube-system:cluster-autoscaler"
...
resource "helm_release" "aws_load_balancer_controller" {
  ...
  # IRSA: annotation no SA criado pelo Helm
  set {
