...
resource "aws_kms_key" "eks" {
  ...
  description             = "KMS key para encryption dos secrets do EKS ${local.cluster_name}"
...
# Policy adicional para SSM (acesso aos nodes via Session Manager)
...
# =============================================================================
# IRSA - IAM Role para Service Accounts (Base)
# =============================================================================

# IAM Role base para aplicações que precisam acessar AWS
resource "aws_iam_role" "irsa_base" {
  name = "${local.cluster_name}-irsa-base"
...
# =============================================================================
# IRSA - Role para acesso ao Secrets Manager
# =============================================================================
